...
struct UIStrings {
    ...
    static let enterEmailToReset = "Enter your uid address to reset the password"
    static let yourEmail = "Your e-mail address"
    static let resetPasswordEmailError = "There was an error while sending reset password uid"
    static let resetPassword = "Reset password"
    static let uidFieldIsEmpty = "Email field is empty"
    ...
    //invitation errors
    static let mustProvideEmailAddress = "You must provide uid address"
    static let yourEmailAddress = "This is your uid address"
