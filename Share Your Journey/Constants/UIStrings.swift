...
struct UIStrings {
    ...
    static let fourthWelcomeText = "4. Invite friends using their emails."
    ...
    static let passwordResetEmail = "Password reset email"
    ...
    static let resetPasswordEmailSent = "Reset password email was sent to"
    ...
    static let verificationEmail = "Verification email"
    static let verificationEmailSent = "A verification email has been sent to"
    static let verifyYourself = ", verify yourself to be able to log in. If you don't find the email, make sure you check the spam."
    static let enterEmailToReset = "Enter your email address to reset the password"
    static let yourEmail = "Your email address"
    ...
    static let accountDeletionChecker = "Are you sure that you want to delete your account? You won't be able to create account using the same email address."
    ...
    static let searchNickname = "Search nickname"
    ...
    static let noJourneysToShow = "No journeys to show."
    static let noJourneysToShowTapToRefresh = "No journeys to show. Tap to refresh."
    ...
    static let enterFriendsNickname = "Enter friend's nickname"
    static let inviteFriend = "Invite friend"
    static let invitationError = "Invitation error"
    static let sendRequest = "Send request"
    //invitation errors
    static let mustProvideNickname = "You must provide nickname"
    static let yourNickname = "This is your nickname"
